...
.equ TIM_0_DELAY_MILISEC = 17; MAX 32 mili sec, MIN 1
.equ TIM_2_DELAY_MILISEC = 17; MAX 32 mili sec, MIN 1
...
USART_TXC: // Ïðåðûâàíèå ïî îòñûëêå áàéòà
	cli // Çàïðåùàåì ïðåðûâàíèÿ
	push r16
	push r18
	push r17
	;sbis UCSRA,UDRE // Ñòàíäàðòíàÿ ïðîâåðêà èç òåõ.äîêà, åñëè UDRE = 1 ïðîïóñêàåì ñëåäóþùóþ ñòðîêó 
	
	lds r18, UCSR0A
    sbrs r18,UDRE0
	rjmp USART_TXC // Ëèáî âðàùàåìñÿ â öèêëå
